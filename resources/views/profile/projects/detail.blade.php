            ...
            <div class="container " data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <div class="col-lg-6">
                        ...
                        <img src="{{ asset('vendor/impact/assets/img/about.jpg') }}" class="img-fluid rounded-4 mb-4"
                            alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <div class="position-relative mt-4">
                                <img src="{{ asset('vendor/impact/assets/img/about-2.jpg') }}" class="img-fluid rounded-4"
                                    alt="">
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-1.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-2') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-3') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-4') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-5') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-6') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-7') }}.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('vendor/impact/assets/img/clients/client-8') }}.png"
                                class="img-fluid" alt=""></div>
                    </div>
                </div>
                    ...
                    <div class="row gy-4 portfolio-container">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <a href="{{ asset('vendor/impact/assets/img/portfolio/app-1.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/app-1.jpg') }}"
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-product">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/product-1.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/product-1.jpg') }}"
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/branding-1.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/branding-1.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-books">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/books-1.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/books-1.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/app-2.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/app-2.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-product">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/product-2.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/product-2.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/branding-2.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/branding-2.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-books">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/books-2.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/books-2.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-app">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/app-3.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/app-3.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-product">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/product-3.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/product-3.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/branding-3.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/branding-3.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
                        ...
                        <div class="col-xl-4 col-md-6 portfolio-item filter-books">
                            <div class="portfolio-wrap">
                                <a href="assets/img/portfolio/books-3.jpg" data-gallery="portfolio-gallery-app"
                                    class="glightbox"><img
                                        src="{{ asset('vendor/impact/assets/img/portfolio/books-3.jpg') }} "
                                        class="img-fluid" alt=""></a>
                                <div class="portfolio-info">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="member">
                            <img src="{{ asset('vendor/impact/assets/img/team/team-1.jpg') }} " class="img-fluid"
                                alt="">
                            <h4>Walter White</h4>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="member">
                            <img src="{{ asset('vendor/impact/assets/img/team/team-2.jpg') }} " class="img-fluid"
                                alt="">
                            <h4>Sarah Jhinson</h4>
                            <span>Marketing</span>
                            <div class="social">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                        <div class="member">
                            <img src="{{ asset('vendor/impact/assets/img/team/team-3.jpg') }} " class="img-fluid"
                                alt="">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
                        <div class="member">
                            <img src="{{ asset('vendor/impact/assets/img/team/team-4.jpg') }} " class="img-fluid"
                                alt="">
                            <h4>Amanda Jepson</h4>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-1.jpg') }} " alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-author.jpg') }} " alt=""
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-2.jpg') }} " alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-author-2.jpg') }} " alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-3.jpg') }} " alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('vendor/impact/assets/img/blog/blog-author-3.jpg') }} " alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
